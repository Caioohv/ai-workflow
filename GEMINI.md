...
This project uses a structured AI-assisted development workflow. Tasks move through a pipeline managed by specialized skills acting as slash commands.
...
These commands are defined as skills under `.agents/skills/` and can be invoked manually in the Antigravity TUI using `/`.
